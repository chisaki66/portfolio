    ...
    <div class="body">
      <div class="body__block">
        ...
        <div class="body__text">
          ...
          <p>
            ...
            主な担当業務は Vue のバージョンアップを行うチームに所属し、リファクタリング系のタスクなどを中心にサービスの保守・運用を行なっていました。
          </p>
          <br>
      ...
      <div class="body__block">
        ...
        <div class="body__text">
          ...
          <br>
          <p>
            Retty 株式会社のフロントエンドエンジニアとして主に Web アプリケーションとコーポレートサイトの開発業務を任せて頂いていました。<br>
            それ以外にも LP ページのコーディングや Python を用いた登録店舗のデータ収集を行うなど精力的に業務に従事していました。
          </p>
          <br>
          <a href="https://www.wantedly.com/id/chisaki0606" target="_blank">詳細な情報はこちら (Wantedly のページリンク)</a>
        </div>
